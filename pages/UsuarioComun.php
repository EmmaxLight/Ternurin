...
<head>
    ...
    <style>
        ...
        .menu-btn {
            ...
            display: flex;
            align-items: center;
            margin-left: 20px; /* Ajuste para centrar más el botón */
        }
        .site-title {
            font-size: 1.5em;
            margin: 0;
            margin-right: 40px; /* Ajuste para mover el título más hacia el centro */
            color: white;
        }
        .sidebar {
            height: 100%;
...
<body>
    ...
    <div id="mySidebar" class="sidebar">
        ...
        <a href="producven.php">Productos</a> <!-- Modificación aquí -->
    ...
    <main id="main">
        ...
        <div class="form-container">
            <!-- Aquí puedes agregar información posteriormente -->
        </div>
    </main>
